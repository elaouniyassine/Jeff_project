                    ...
                    tags$div(
                      ...
                      tags$div(
                        ...
                        tags$aside(class = "aside",
                                   tags$nav(class = "aside-nav",
                                            tags$ul(class = "list",
                                                    `data-spollers` = "", `data-one-spoller` = "",
                                                    
                                                    tags$li(class = "item dropdown child-active",
                                                            tags$div(class = "dropdown-top",
                                                                     tags$div(class = "dropdown-arrow",
                                                                              tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "20", viewBox = "0 -960 960 960", width = "24",
                                                                                       tags$path(d = "M400-280v-400l200 200-200 200Z")
                                                                              )
                                                                     ),
                                                                     tags$div(class = "dropdown-icon item-icon", 
                                                                              tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "48", viewBox = "0 -960 960 960", width = "48",
                                                                                       tags$path(d = "m123-240-43-43 292-291 167 167 241-241H653v-60h227v227h-59v-123L538-321 371-488 123-240Z")
                                                                              )
                                                                     ),
                                                                     tags$span(class = "item-text", "Summary metrics")
                                                            ),
                                                            tags$div(class = "dropdown-content",
                                                                     tags$ul(class = "sublist",
                                                                             tags$li(class = "subitem",
                                                                                     tags$a(href = "#summary-metrics-yoy",`data-toggle` = "tab", class = "link active", "Summary metrics yoy")
                                                                             )
                                                                     )
                                                            )
                                                    ),
                                                    tags$li(class = "item dropdown",
                                                            tags$div(class = "dropdown-top",
                                                                     tags$div(class = "dropdown-arrow",
                                                                              tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "", viewBox = "0 -960 960 960", width = "24",
                                                                                       tags$path(d = "M400-280v-400l200 200-200 200Z")
                                                                              )
                                                                     ),
                                                                     tags$div(class = "dropdown-icon item-icon",
                                                                              tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "48", viewBox = "0 -960 960 960", width = "48",
                                                                                       tags$path(d = "M481-80q-82 0-155-31.5T198.5-197q-54.5-54-86-127T81-479q0-158 106.5-272T452-877v102q-115 11-192 95.5T183-479q0 124 87 210.5T481-182q72 0 136-32.5T726-306l88 51q-58 83-145.5 129T481-80Zm362-229-88-49q12-31 18-61.5t6-60.5q0-116-76.5-201T512-776v-102q157 11 263 124.5T881-484q0 45-9.5 88.5T843-309Z")
                                                                              )
                                                                     ),
                                                                     tags$span(class = "item-text", "Cohort Analysis")
                                                            ),
                                                            tags$div(class = "dropdown-content",
                                                                     tags$ul(class = "sublist",
                                                                             tags$li(class = "subitem dropdown subitem-dropdown",
                                                                                     tags$div(class = "dropdown-top",
                                                                                              tags$div(class = "dropdown-arrow",
                                                                                                       tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "", viewBox = "0 -960 960 960", width = "24",
                                                                                                                tags$path(d = "M400-280v-400l200 200-200 200Z")
                                                                                              ...
                                                                                              tags$span(class = "item-text", "Cohort summary")
                                                                                     ),
                                                                                     tags$div(class = "dropdown-content",
                                                    ...
                                                    tags$li(class = "item single-item",`data-toggle` = "tab",
                                                            tags$a(href = "#Geography",`data-toggle` = "tab", class = "link",
                                                                   tags$div(class = "item-icon",
                                                                            tags$svg(xmlns = "http://www.w3.org/2000/svg", height = "48", viewBox = "0 -960 960 960", width = "48",
                                                                                     tags$path(d = "M480.089-490Q509-490 529.5-510.589q20.5-20.588 20.5-49.5Q550-589 529.411-609.5q-20.588-20.5-49.5-20.5Q451-630 430.5-609.411q-20.5 20.588-20.5 49.5Q410-531 430.589-510.5q20.588 20.5 49.5 20.5ZM480-159q133-121 196.5-219.5T740-552q0-117.79-75.292-192.895Q589.417-820 480-820t-184.708 75.105Q220-669.79 220-552q0 75 65 173.5T480-159Zm0 79Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880q127 0 223.5 89T800-552q0 100-79.5 217.5T480-80Zm0-472Z")
                                                                            )
                                                                   ),
                                                                   tags$span(class = "item-text", "Geography")
                                                            )
                                                    )
                                            )
                                   )
                      ...
                      ,tags$div(
                        ...
                        tags$div(
                          ...
                          id = "category-economics-summary",
                                    h2("Category Economics Summary", class = "title_sidebar"),
                                    br(),
                        ...
                        tags$div(
                          ...
                          id = "cohort-financial-contribution",
                                    h2("Cohort Financial Contribution", class = "title_sidebar"),
                                    br(),
                        ...
                        tags$div(
                          ...
                          id = "repeat-revenue-trend",
                           ...
                           br(),br(),
                          downloadButton('DnldCohortFinancialTable', 'Download Cohort Table'),br(),
                        ...
                        tags$div(
                          ...
                          id = "Repeat-Frequency",
                           ...
                           br(),br(),        
                          highchartOutput("repeatFrequency")%>% 
                                     withSpinner(size = 1.1, color = "#ff8c04", type = 4),
                           
                          highchartOutput("cumLTVDist") %>% 
                                     withSpinner(size = 1.1, color = "#ff8c04", type = 4),
                        ...
                        tags$div(
                          class = "tab-pane",
                          id = "Geography",
                          uiOutput("geoMapYears"),br(),
                          p("Revenue per capita by state or county",class = "title_sidebar", style = "font-size:14px; line-height:1.5;"),br(),
                          p("Broken into 5 quantiles; coded by color",class = "title_sidebar", style = "font-size:14px; margin-bottom:-20px; line-height:1.5;"),br(),
                          shinyWidgets::radioGroupButtons(
